...
//=========================================================================
// 文件名称：CRS2TClass4StandardClass1.cs
// 项目名称：请更改为当前模块名称或相关功能名称
// 创建时间：2021-01-19 15:39:00
// 创建人员：宋杰军
// 负责人员：宋杰军
// 参与人员：宋杰军
// ========================================================================
...
namespace DotNetBar4App01
{
    ...
    /// 消息提示窗体
    /// </summary>
    public sealed class MsgBox4DotNetBar
    {
        /// <summary>
        /// 消息提示窗体类型
        /// </summary>
        ...
        private static DialogResult ShowDialogForm(string text, string caption, int numSecond, Bitmap icon, DialogType dialogType)
        {
            ...
            btnOK.Padding = new System.Windows.Forms.Padding(0);
                ...
                case DialogType.ConfirmDialog:
                    {
                        ...
                        btnCancel.Padding = new System.Windows.Forms.Padding(0);
